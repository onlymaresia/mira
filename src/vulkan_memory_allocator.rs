...
pub const VK_SHADER_MODULE_CREATE_FLAG_BITS_MAX_ENUM:
...
pub const VMA_ALLOCATOR_CREATE_EXTERNALLY_SYNCHRONIZED_BIT:
    VmaAllocatorCreateFlagBits = 1;
pub const VMA_ALLOCATOR_CREATE_KHR_DEDICATED_ALLOCATION_BIT:
    VmaAllocatorCreateFlagBits = 2;
pub const VMA_ALLOCATOR_CREATE_KHR_BIND_MEMORY2_BIT:
    VmaAllocatorCreateFlagBits = 4;
pub const VMA_ALLOCATOR_CREATE_EXT_MEMORY_BUDGET_BIT:
    VmaAllocatorCreateFlagBits = 8;
pub const VMA_ALLOCATOR_CREATE_AMD_DEVICE_COHERENT_MEMORY_BIT:
    VmaAllocatorCreateFlagBits = 16;
pub const VMA_ALLOCATOR_CREATE_BUFFER_DEVICE_ADDRESS_BIT:
    VmaAllocatorCreateFlagBits = 32;
pub const VMA_ALLOCATOR_CREATE_EXT_MEMORY_PRIORITY_BIT:
    VmaAllocatorCreateFlagBits = 64;
pub const VMA_ALLOCATOR_CREATE_FLAG_BITS_MAX_ENUM:
...
pub const VMA_ALLOCATION_CREATE_DEDICATED_MEMORY_BIT:
    VmaAllocationCreateFlagBits = 1;
pub const VMA_ALLOCATION_CREATE_NEVER_ALLOCATE_BIT:
    VmaAllocationCreateFlagBits = 2;
pub const VMA_ALLOCATION_CREATE_MAPPED_BIT:
    VmaAllocationCreateFlagBits = 4;
pub const VMA_ALLOCATION_CREATE_USER_DATA_COPY_STRING_BIT:
    VmaAllocationCreateFlagBits = 32;
pub const VMA_ALLOCATION_CREATE_UPPER_ADDRESS_BIT:
    VmaAllocationCreateFlagBits = 64;
pub const VMA_ALLOCATION_CREATE_DONT_BIND_BIT:
    VmaAllocationCreateFlagBits = 128;
pub const VMA_ALLOCATION_CREATE_WITHIN_BUDGET_BIT:
    VmaAllocationCreateFlagBits = 256;
pub const VMA_ALLOCATION_CREATE_CAN_ALIAS_BIT:
    VmaAllocationCreateFlagBits = 512;
pub const VMA_ALLOCATION_CREATE_HOST_ACCESS_SEQUENTIAL_WRITE_BIT:
    VmaAllocationCreateFlagBits = 1024;
pub const VMA_ALLOCATION_CREATE_HOST_ACCESS_RANDOM_BIT:
    VmaAllocationCreateFlagBits = 2048;
pub const VMA_ALLOCATION_CREATE_HOST_ACCESS_ALLOW_TRANSFER_INSTEAD_BIT : VmaAllocationCreateFlagBits = 4096 ;
pub const VMA_ALLOCATION_CREATE_STRATEGY_MIN_MEMORY_BIT:
    VmaAllocationCreateFlagBits = 65536;
pub const VMA_ALLOCATION_CREATE_STRATEGY_MIN_TIME_BIT:
    VmaAllocationCreateFlagBits = 131072;
pub const VMA_ALLOCATION_CREATE_STRATEGY_MIN_OFFSET_BIT:
    VmaAllocationCreateFlagBits = 262144;
pub const VMA_ALLOCATION_CREATE_STRATEGY_BEST_FIT_BIT:
    VmaAllocationCreateFlagBits = 65536;
pub const VMA_ALLOCATION_CREATE_STRATEGY_FIRST_FIT_BIT:
    VmaAllocationCreateFlagBits = 131072;
pub const VMA_ALLOCATION_CREATE_STRATEGY_MASK:
    VmaAllocationCreateFlagBits = 458752;
pub const VMA_ALLOCATION_CREATE_FLAG_BITS_MAX_ENUM:
...
pub const VMA_POOL_CREATE_IGNORE_BUFFER_IMAGE_GRANULARITY_BIT:
...
pub const VMA_DEFRAGMENTATION_FLAG_ALGORITHM_FAST_BIT:
    VmaDefragmentationFlagBits = 1;
pub const VMA_DEFRAGMENTATION_FLAG_ALGORITHM_BALANCED_BIT:
    VmaDefragmentationFlagBits = 2;
pub const VMA_DEFRAGMENTATION_FLAG_ALGORITHM_FULL_BIT:
    VmaDefragmentationFlagBits = 4;
pub const VMA_DEFRAGMENTATION_FLAG_ALGORITHM_EXTENSIVE_BIT:
    VmaDefragmentationFlagBits = 8;
pub const VMA_DEFRAGMENTATION_FLAG_ALGORITHM_MASK:
    VmaDefragmentationFlagBits = 15;
pub const VMA_DEFRAGMENTATION_FLAG_BITS_MAX_ENUM:
...
pub const VMA_DEFRAGMENTATION_MOVE_OPERATION_COPY:
    VmaDefragmentationMoveOperation = 0;
pub const VMA_DEFRAGMENTATION_MOVE_OPERATION_IGNORE:
    VmaDefragmentationMoveOperation = 1;
pub const VMA_DEFRAGMENTATION_MOVE_OPERATION_DESTROY:
    VmaDefragmentationMoveOperation = 2;
pub type VmaDefragmentationMoveOperation = ::std::os::raw::c_uint;
pub const VMA_VIRTUAL_BLOCK_CREATE_LINEAR_ALGORITHM_BIT:
    VmaVirtualBlockCreateFlagBits = 1;
pub const VMA_VIRTUAL_BLOCK_CREATE_ALGORITHM_MASK:
    VmaVirtualBlockCreateFlagBits = 1;
pub const VMA_VIRTUAL_BLOCK_CREATE_FLAG_BITS_MAX_ENUM:
...
pub const VMA_VIRTUAL_ALLOCATION_CREATE_UPPER_ADDRESS_BIT:
    VmaVirtualAllocationCreateFlagBits = 64;
pub const VMA_VIRTUAL_ALLOCATION_CREATE_STRATEGY_MIN_MEMORY_BIT : VmaVirtualAllocationCreateFlagBits = 65536 ;
pub const VMA_VIRTUAL_ALLOCATION_CREATE_STRATEGY_MIN_TIME_BIT:
    VmaVirtualAllocationCreateFlagBits = 131072;
pub const VMA_VIRTUAL_ALLOCATION_CREATE_STRATEGY_MIN_OFFSET_BIT : VmaVirtualAllocationCreateFlagBits = 262144 ;
pub const VMA_VIRTUAL_ALLOCATION_CREATE_STRATEGY_MASK:
    VmaVirtualAllocationCreateFlagBits = 458752;
pub const VMA_VIRTUAL_ALLOCATION_CREATE_FLAG_BITS_MAX_ENUM:
